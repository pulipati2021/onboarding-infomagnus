...
File_object_read=open("/home/runner/work/onboarding-infomagnus/onboarding-infomagnus/completed.txt", "r")  
...
for emailkey,emailvalue in enumerate(email_data):
  ...
  if emailvalue not in content:
   ...
   # print("The string does not exist in the file."+emailvalue)
    File_object_write=open("/home/runner/work/onboarding-infomagnus/onboarding-infomagnus/completed.txt", "w+")
    File_object_write.write(emailvalue+"\n") 
   # print(email_data[emailvalue])
